...
import com.cheng.lib.processor.exception.*
import com.cheng.lib.processor.ProcessorUnit
import com.cheng.lib.processor.RuntimePermissionsElement
import com.cheng.lib.processor.TYPE_UTILS
import java.util.*
...
fun checkSpecialPermissionsWithNeverAskAgain(
    items: List<ExecutableElement>,
    annotationClass: Class<OnNeverAskAgain> = OnNeverAskAgain::class.java
) {
    items.forEach {
        val permissionValue = it.getAnnotation(annotationClass).permissionValue()
